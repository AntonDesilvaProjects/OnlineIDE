...
folder are mapped to the application's root namespace, 'OnlineIDE'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'OnlineIDE' in the same way
as `"OnlineIDE/sass/src"`.
